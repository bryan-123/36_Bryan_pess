...
if (isset($_POST["btnUpdate"])) {
	...
	if ($_POST["patrolCarStatus"] == '4') {
		...
		$sql = "UPDATE dispatch SET time_arrived = NOW()
			WHERE time_arrivved is NULL AND patrolcar_id = ?";
	...
	} else if ($_POST["patrolCarStatus"] == '3') { // else if patrol car status is FREE (3) then capture the line of completion
...
<body>
<!----START OF STEP 7 IN THE PROJECT AND DEPLOY_V1.DOCX---->
				<!-- PART 1 -->
...
?>
<!------END OF STEP 9 IN THE PROJECT 7 PROGRAM AND DEPLOY V1 DOCX---->

<!--- START OF STEP 10 IN THE PROJECT 7 PROGRAM AND DEPLOY V1 DOCX---->
